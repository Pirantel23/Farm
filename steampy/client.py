...
class SteamClient:
    def __init__(self, api_key: str, username: str = None, password: str = None, steam_guard:str = None, identity: str = None, steamid: str = None) -> None:
    ...
    def login(self, username: str, password: str, steam_guard: str) -> None:
        ...
        self.username = username
        self._password = password
        LoginExecutor(username, password, steam_guard, self._session).login()
    ...
    def _confirm_transaction(self, trade_offer_id: str) -> dict:
        confirmation_executor = ConfirmationExecutor(self.identity, self.steamid,
                                                     self._session)
